...
ytdl_format_options = {
    ...
    # Bypasses for data center IPs
    'youtube_include_dash_manifest': False,
    'youtube_include_hls_manifest': False,
}

# Advanced Extraction Bypasses
# We use 'web' as primary because your cookie.txt is from a desktop browser
...
class YTDLSource(discord.PCMVolumeTransformer):
    ...
    async def from_url(cls, url, *, loop=None, stream=False):
        ...
        try:
            # Note: We must create a NEW ytdl instance for every request when using cookies on servers
            # to prevent session cross-talk and "Reload" errors.
